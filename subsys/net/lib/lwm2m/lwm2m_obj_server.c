...
#define SERVER_MAX_ID		 28
#elif defined(CONFIG_LWM2M_SERVER_OBJECT_VERSION_1_1)
...
#endif /* defined(CONFIG_LWM2M_SERVER_OBJECT_VERSION_1_1) */
#if defined(CONFIG_APP_CONNECTIVITY_LORA)
	OBJ_FIELD_DATA(SERVER_ALTERNATE_APN_LINKS_ID, RW_OPT, OBJLNK),
	OBJ_FIELD_DATA(SERVER_SUPPORTED_SERVER_VERSIONS_ID, R_OPT, STRING),
	OBJ_FIELD_DATA(SERVER_DEFAULT_NOTIFICATION_MODE_ID, RW_OPT, U8),
	OBJ_FIELD_DATA(SERVER_PROFILE_ID_HASH_ALGORITHM_ID, RW_OPT, U8),
#endif /* defined(CONFIG_APP_CONNECTIVITY_LORA) */
